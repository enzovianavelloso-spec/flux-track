...
function Marca() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <rect x="10.5" y="9.5" width="3" height="8.5" rx="1.5" fill="var(--dado)" />
  ...
  return (
    <header className="topo">
      <div className="topo-interno">
        ...
        {/* Sempre verdadeiro por construção: as duas páginas que usam este cabeçalho
            consultam o banco antes de renderizar — sem banco, nem chegam aqui. */}
