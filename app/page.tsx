...
import { dinheiro, porcento, inteiro, dataBr, comFiltros, calcularPeriodo, InfoIcone, Metrica } from "./_lib/ui";
...
export default async function PainelPage({
  ...
  const { periodos, tudo, from, to, semFiltroData, filtroHojeImplicito } = calcularPeriodo(sp, new Date());
